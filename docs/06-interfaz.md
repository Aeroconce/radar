...
- **Filtros**, todos combinables y reflejados en la URL para compartir enlaces: estado (chips con conteo), vertical, tipo de comprador, tipo de proceso, región y tramo de monto (incluye «sin monto publicado»). Cada desplegable lista solo los valores con filas, con su conteo. «Exportar a Excel» baja lo filtrado (RF-11, D-34). Las que están **bajo el umbral vigente se ocultan por defecto** (D-42, D-46); la casilla «Mostrar bajo el umbral» las trae de vuelta, y los conteos de estado y la exportación siguen la misma regla. Lo mismo con las **cerradas** (D-50): si el portal ya no las lista como Publicada o su cierre pasó, se ocultan salvo que tengan oferta presentada (ofertada, adjudicada, perdida); la casilla «Mostrar cerradas» las trae, con la etiqueta «Cerrada en el portal» o «cerrada el <fecha>» en la fila.
