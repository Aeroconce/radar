...
| `history` (RF-08) | diario 04:00 | `getAwardedOn(ayer)`; para las coincidentes con las reglas (mismo motor, umbral 3): ficha, acta y parseo; crear `HistoricalAward` y `HistoricalBid`. Ejecución manual con rango de fechas: `pnpm worker:historico -- 2026-08-01 2026-08-31`. |
