...
- **T-07** Subir Node del VPS de **20.20.0** a **22 LTS**. No es urgente (Next 16 exige ≥ 20.9 y funciona), pero el VPS es compartido y el cambio afecta a los otros ocho proyectos: hay que coordinarlo.
